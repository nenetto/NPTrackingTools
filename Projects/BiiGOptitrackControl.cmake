...
set(EP_REQUIRED_PROJECTS NPTrackingTools tinyxml2 ITK)
set(EP_OPTION_DESCRIPTION "BiiGOptitrackControl")
...
set(EP_CMAKE_ARGS
  ...
  -D${EP_NAME}_BUILD_SHARED:BOOL=ON
...
if(${${PROJECT_NAME}_BUILD_DOCUMENTATION})
  list(APPEND EP_CMAKE_ARGS
    -D${EP_NAME}_BUILD_DOCUMENTATION:BOOL=ON
    -D${PROJECT_NAME}_BUILD_DOCUMENTATION:BOOL=ON
